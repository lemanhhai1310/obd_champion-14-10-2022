            ...
            <div class="uk-grid-small uk-child-width-1-3 uk-grid-match" uk-grid>
                <div class="uk-width-1-1">
                    <div class="uk-position-relative">
                        <h2 class="uk-h2 uk-text-center giaithuong__title">Đấu trường 3</h2>
                    </div>
                </div>
                <?php
                $data = array(
                    array(
                        'img' => 'images/folder/3.1.png',
                        'txt' => '7 triệu đồng',
                        'percent' => '25%',
                    ),
                    array(
                        'img' => 'images/folder/3.2.png',
                        'txt' => '7 triệu đồng',
                        'percent' => '25%',
                    ),
                    array(
                        'img' => 'images/folder/3.3.png',
                        'txt' => '15 triệu đồng',
                        'percent' => '25%',
                    ),
                    array(
                        'img' => 'images/folder/3.4.png',
                        'txt' => '30 triệu đồng',
                        'percent' => '24%',
                    ),
                    array(
                        'img' => 'images/folder/3.5.png',
                        'txt' => '300 triệu đồng',
                        'percent' => '1%',
                    ),
                );

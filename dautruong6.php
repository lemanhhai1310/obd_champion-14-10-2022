            ...
            <div class="uk-grid-small uk-child-width-1-3 uk-grid-match" uk-grid>
                <div class="uk-width-1-1">
                    <div class="uk-position-relative">
                        <h2 class="uk-h2 uk-text-center giaithuong__title">Đấu trường 6</h2>
                    </div>
                </div>
                <?php
                $data = array(
                    array(
                        'img' => 'images/folder/6.1.png',
                        'txt' => '20 triệu đồng',
                        'percent' => '25%',
                    ),
                    array(
                        'img' => 'images/folder/6.2.png',
                        'txt' => '20 triệu đồng',
                        'percent' => '25%',
                    ),
                    array(
                        'img' => 'images/folder/6.3.png',
                        'txt' => '40 triệu đồng',
                        'percent' => '25%',
                    ),
                    array(
                        'img' => 'images/folder/6.4.png',
                        'txt' => '100 triệu đồng',
                        'percent' => '24%',
                    ),
                    array(
                        'img' => 'images/folder/6.5.png',
                        'txt' => '800 triệu đồng',
                        'percent' => '1%',
                    ),
                );

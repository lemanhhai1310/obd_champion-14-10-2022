            ...
            <div class="uk-grid-small uk-child-width-1-3 uk-grid-match" uk-grid>
                <div class="uk-width-1-1">
                    <div class="uk-position-relative">
                        <h2 class="uk-h2 uk-text-center giaithuong__title">Đấu trường 4</h2>
                    </div>
                </div>
                <?php
                $data = array(
                    array(
                        'img' => 'images/folder/4.1.png',
                        'txt' => '10 triệu đồng',
                        'percent' => '25%',
                    ),
                    array(
                        'img' => 'images/folder/4.2.png',
                        'txt' => '10 triệu đồng',
                        'percent' => '25%',
                    ),
                    array(
                        'img' => 'images/folder/4.3.png',
                        'txt' => '20 triệu đồng',
                        'percent' => '25%',
                    ),
                    array(
                        'img' => 'images/folder/4.4.png',
                        'txt' => '40 triệu đồng',
                        'percent' => '24%',
                    ),
                    array(
                        'img' => 'images/folder/4.5.png',
                        'txt' => '400 triệu đồng',
                        'percent' => '1%',
                    ),
                );

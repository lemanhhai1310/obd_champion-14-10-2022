            ...
            <div class="uk-grid-small uk-child-width-1-3 uk-grid-match" uk-grid>
                <div class="uk-width-1-1">
                    <div class="uk-position-relative">
                        <h2 class="uk-h2 uk-text-center giaithuong__title">Đấu trường 2</h2>
                ...
                $data = array(
                    array(
                        'img' => 'images/folder/2.1.png',
                        'txt' => '5 triệu đồng',
                        'percent' => '25%',
                    ),
                    array(
                        'img' => 'images/folder/2.2.png',
                        'txt' => '5 triệu đồng',
                        'percent' => '25%',
                    ),
                    array(
                        'img' => 'images/folder/2.3.png',
                        'txt' => '7 triệu đồng',
                        'percent' => '25%',
                    ),
                    array(
                        'img' => 'images/folder/2.4.png',
                        'txt' => '10 triệu đồng',
                        'percent' => '24%',
                    ),
                    array(
                        'img' => 'images/folder/2.5.png',
                        'txt' => '200 triệu đồng',
                        'percent' => '1%',
                    ),
                );
